...
public interface InboxQuestionService {
    ...
    void createQuestion(Question_anwsers question);

    void eraseAnswerReadFlag(Integer id);

    int getUnreadNums(Integer id);

    int getUnreadQuestion();
}
