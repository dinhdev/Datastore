 ...
 *  for example  , when the return result is "admin/vendor/table" , it means admin/vendor/table.html file
 *  so the browser loads the admin/vendor/table.html file for frontend.
 *
...
public class AdminVendorController extends AdminAbstractController {
     ...
     * For example , if you locate page to http://localhost/admin/vendor/edit/1 , then this function will be called.
     * Then it will get item based on id param and put attribute in model variable.
     * So it can be used in frontend edit page.
     * This function is mapped admin/vendor/edit.html file.
    ...
    public String editPage(@PathVariable Integer id, HttpSession session, Model model){
       ...
       if(user.getExpire_date() == null){
        ...
        Vendors vendor = vendorService.getVendorIDById(user.getVendor_id());

        model.addAttribute("vendor",vendor);
        model.addAttribute("userinfo",user);
        return "admin/vendor/userEdit";
    }

    /**
     * This is function implements to add item page.
     * This function will be used when you navigate add page.
     * For example , if you locate page to http://localhost/admin/vendor/add , then this function will be called.
     * This function is mapped admin/vendor/add.html file.
     * @return String This param is url for frontend page file.
     */
    @RequestMapping("/add")
    public String addPage(HttpSession session, Model model){
        ...
        return "admin/vendor/userAdd";
    }

    /**
     * This is function implements to list items page.
     * This function will be used when you navigate list page.
     * For example , if you locate page to http://localhost/admin/vendor/list , then this function will be called.
     * This function is mapped admin/vendor/list.html file.
     * @return String This param is url for frontend page file.
     */
    @RequestMapping("/list")
     ...
     * For example , if you locate page to http://localhost/admin/vendor/list , then this function will be called to get table data by pager.
     * This function is mapped admin/vendor/table.html file.
     * @param pager It is used for page navigation function.
