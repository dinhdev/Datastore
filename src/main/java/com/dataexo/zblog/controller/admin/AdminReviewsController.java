...
/**
 * This is controller class implements an management of reviews table in admin panel.
 ...
 *
 * <p> This class is integrate with templates/admin/reviews folder
 *  for example  , when the return result is "admin/reviews/table" , it means admin/reviews/table.html file
 *  so the browser loads the admin/reviews/table.html file for frontend.
 *
...
public class AdminReviewsController extends AdminAbstractController {
    ...
    @ResponseBody
    public Pager initPage(Pager<Customer_reviews> pager, Model model){
     ...
     * For example , if you locate page to http://localhost/admin/reviews/edit/1 , then this function will be called.
     * Then it will get item based on id param and put attribute in model variable.
     * So it can be used in frontend edit page.
     * This function is mapped admin/reviews/edit.html file.
     ...
     * For example , if you locate page to http://localhost/admin/reviews/add , then this function will be called.
     * This function is mapped admin/reviews/add.html file.
     * @return String This param is url for frontend page file.
     */
    @RequestMapping("/add")
     ...
     * For example , if you locate page to http://localhost/admin/reviews/list , then this function will be called.
     * This function is mapped admin/reviews/list.html file.
     * @return String This param is url for frontend page file.
     */
    @RequestMapping("/list")
     ...
     * For example , if you locate page to http://localhost/admin/reviews/list , then this function will be called to get table data by pager.
     * This function is mapped admin/reviews/table.html file.
     * @param pager It is used for page navigation function.
     ...
     */
    @RequestMapping("/load")
    public String loadList(Pager<Customer_reviews> pager,String name,Model model){
