...
@Controller
@RequestMapping("/admin/data_region")
public class AdminData_RegionController extends AdminAbstractController {

    /**
     * This is dao variable to connect database.
     * Mainly this variable get data from asset_table.
     * It contains findAll,savedata_region,checkExist,loaddata_region,getdata_regionById ...
     */
    @Resource
     ...
     * For example , if you locate page to http://localhost/admin/data_region/edit/1 , then this function will be called.
     * Then it will get item based on id param and put attribute in model variable.
     * So it can be used in frontend edit page.
     * This function is mapped admin/data_region/edit.html file.
    ...
    public String editPage(@PathVariable Integer id, HttpSession session, Model model){
        ...
        Region data = regionService.getRegionById(id);

        model.addAttribute("data",data);
        return "admin/data_region/edit";
    }

    /**
     * This is function implements to add item page.
     * This function will be used when you navigate add page.
     * For example , if you locate page to http://localhost/admin/data_region/add , then this function will be called.
     * This function is mapped admin/data_region/add.html file.
     * @return String This param is url for frontend page file.
     */
    @RequestMapping("/add")
    public String addPage(HttpSession session, Model model){
        ...
        return "admin/data_region/add";
    }

    /**
     * This is function implements to list items page.
     * This function will be used when you navigate list page.
     * For example , if you locate page to http://localhost/admin/data_region/list , then this function will be called.
     * This function is mapped admin/data_region/list.html file.
     * @return String This param is url for frontend page file.
     */
    @RequestMapping("/list")
     ...
     * For example , if you locate page to http://localhost/admin/data_region/list , then this function will be called to get table data by pager.
     * This function is mapped admin/data_region/table.html file.
     * @param pager It is used for page navigation function.
     *  @param name It is used for search data by name. If you are going to search name of data_region ,
    ...
    public String loadList(Pager<Publisher> pager,String name,Model model){
        ...
        List<Region> dataList = regionService.loadRegion(pager,null);

        model.addAttribute("dataList",dataList);
        return "admin/data_region/table";
    }
