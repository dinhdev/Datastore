$(function() {
    ...
    $("#contact-us-list-li").attr("class","active");
...
$("#dataList").on('click','.user-edit',function () {
    var id = $(this).parent().data("id");
    window.location.href= "/admin/contact_us/edit/"+id;
});
