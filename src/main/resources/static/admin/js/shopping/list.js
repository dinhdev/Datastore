$(function() {
    ...
    $("#data-shopping-list-li").attr("class","active");
        ...
        buttons: {
            primary: {
                text: 'OK', style: 'primary', action: function () {
                    $.ajax({
                        url : '/admin/shopping/delete',
                        method: "POST",
                        data:'id='+id,
                        success  : function(data) {
                            if(data.resultCode == 'success'){
                                autoCloseAlert(data.errorInfo,1000);
                                window.location.href = "/admin/shopping/list";
                            }else{
                                autoCloseAlert(data.errorInfo,1000);
                            }
                        }
...
$("#dataList").on('click','.user-edit',function () {
    var id = $(this).parent().data("id");
	window.location.href= "/admin/shopping/edit/"+id;
});
