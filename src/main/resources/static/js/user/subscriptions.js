...
$(function(){
    ...
    $.ajax({
        type: 'GET',
        url: '/account/load/initSubscriptionPage',
        data:pager,
...
$("#main-article").on('click','.user-subscribe',function () {
    var id = $(this).parent().data("id");
    window.location.href= "/account/membership/manage/"+id;
});
