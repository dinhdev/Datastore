$(function() {
   ...
   // $("#coupon-marketadd-li").parent().addClass("in");
    ...
    $.ajax({
        url: '/vendor/couponmarketing/initPage',
        data: 'page=' + page,
...
function loadList(){
	...
	// 查询列表
	$.ajax({
        url : '/vendor/couponmarketing/load',
...
$("#dataList").on('click','.user-edit',function () {
    var id = $(this).parent().data("id");
	window.location.href= "/vendor/couponmarketing/edit/"+id;
});
