...
$('#btnUpdate').on('click',function(){
    ...
    $.ajax({
        url:'/vendor/inbox/question/answer/update/'+id,
        type:'POST',
        data: {
            'content' : content,
            'votes' : votes
        ...
        success: function(data){
            ...
            window.location.href = "/vendor/inbox/question/answer/list/"+parent_id;
        }
...
$('#btnSave').on('click',function(){
    ...
    var createAnswerUrl = "/vendor/inbox/question/answer/create";
