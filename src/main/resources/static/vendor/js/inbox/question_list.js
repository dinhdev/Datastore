$(function() {
   ...
   // $("#user-list-li").parent().addClass("in");
    ...
    $.ajax({
        url: '/vendor/inbox/question/initPage',
        data: 'page=' + page,
...
function loadList(){
	...
	// 查询列表
	$.ajax({
        url : '/vendor/inbox/question/load',
...
$("#dataList").on('click','.user-edit',function () {
    var id = $(this).parent().data("id");
    window.location.href= "/vendor/inbox/question/edit/"+id;
});
    ...
    new $.flavr({
        ...
        buttons: {
            primary: {
                text: 'OK', style: 'primary', action: function () {
                    $.ajax({
                        url : '/vendor/inbox/question/delete',
                        method: "POST",
                        data: {
                            'id' : id
                        },
...
$('#addQuestion').on('click',function(){
    ...
    window.location.href= "/vendor/inbox/question/add";
});
